...
export default function NewsLetter() {
  ...
  return (
    <section className="w-full z-10 h-auto bg-[#3F3D91] flex items-center justify-center flex-col gap-[20px] py-12">
      <div className="claracontainer px-0 md:px-2 lg:px-0 w-full flex flex-col lg:flex-row lg:justify-between justify-center items-center gap-4">
        <Image
          alt="Kindi"
          src={NewsletterImg}
          className="-mt-[90px] w-[320px] z-10 max-h-[400px] md:max-h-[700px] md:h-[250px] md:w-[300px]  md:-mt-[80px] "
        />
        <div className="w-full flex flex-col gap-4 px-4 lg:pr-0 lg:px-4">
          <div className="flex flex-col w-full gap-[12px]">
            <h2 className="text-white claraheading uppercase text-center lg:text-start">
              SUBSCRIBE TO OUR <br />
              <span className="text-red uppercase">Newsletter </span>
              <span className="text-[#ffffff] uppercase">for offers</span>
            </h2>

            <p className="text-white text-center lg:text-start clarabodyTwo">
              Plus *1st month free when you sign up for annual plan.
            </p>
          </div>
          <form
            onSubmit={handleSubmit}
            className="flex w-full flex-col gap-2 items-center justify-start md:justify-center lg:justify-start"
          >
            <div className="flex w-full flex-col md:flex-row gap-2 md:gap-0 items-center justify-center lg:justify-start">
              <Input
                type="email"
