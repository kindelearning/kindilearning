                ...
                >
                  ...
                  {eventCount > 1 ? (
                    ...
                    <>
                      <div className="flex p-2 bg-white shadow-md rounded-lg flex-col w-full gap-1 justify-between items-start">
                        <div className="flex w-full justify-between gap-1 lg:gap-0 items-start">
                          <p className="font-semibold flex lg:hidden text-[14px] leading-[16px] lg:text-[12px] lg:leading-[12px] text-start">
                            {event.title}
                          </p>
                          <p className="font-semibold hidden lg:flex text-[14px] leading-[16px] lg:text-[12px] lg:leading-[12px] text-start">
                            {(event.title || "").slice(0, 16)}
                          </p>
                          {/* Drag icon */}
                          <div className="cursor-grab text-gray-500 items-start">
                            <span className="text-[14px] flex items-start">
                              ⋮⋮
                            </span>{" "}
                          </div>
                        </div>
                      ...
                      >
                        ...
                        <Link
                          target="_blank"
                          href={`/p/activities/${event.id}`}
                          className={`w-[max-content] hover:scale-105 duration-200 px-[8px] -mt-[12px] flex py-[6px]  bg-red  shadow-md rounded-md p-2 text-sm`}
                        >
                          <p className="font-semibold flex text-white  justify-end items-center  leading-[12px] text-start">
                            Lets Start &nbsp;{" "}
                            <ArrowRight className="text-[10px] w-[12px] h-[12px]" />
                          </p>
                        </Link>
