...
export default async function Hero() {
  ...
  return (
    <section className="w-full min-h-screen h-full md:min-h-[600px] md:h-full lg:h-full bg-[#4b4097] pt-4 pb-12 md:py-24 lg:py-28 items-start md:items-center justify-center flex flex-col md:flex-row gap-[20px]">
