...
export default async function Hero() {
  ...
  return (
    <section className="w-full min-h-screen h-full md:min-h-[600px] md:h-full lg:h-full bg-[#443190] pt-4 pb-12 md:py-24 lg:py-28 items-start md:items-center justify-center flex flex-col md:flex-row gap-[20px]">
      <div className="claracontainer w-full flex flex-col-reverse justify-between md:items-center lg:flex-row px-0 md:px-2 lg:px-0 xl:px-0 bg-[#443190] xl:flex-row gap-8 md:gap-0 lg:gap-4 ">
