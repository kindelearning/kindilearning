  ...
  return (
    <>
      <section className="w-full h-auto bg-[#4e2f71] items-center justify-center py-4 flex flex-col md:flex-row gap-[20px] duration-300 animate-fade-in">
        <div className="claracontainer w-full px-4 md:px-2 lg:px-4 py-6 flex-col justify-start items-center gap-7 inline-flex">
          ...
          <div className="flex w-full justify-center items-center flex-col gap-12">
            <div className="flex flex-col-reverse lg:flex-row xl:flex-row w-full items-center justify-between py-8 gap-4">
              <div className="min-h-[300px] animate-fade-in  flex flex-col md:flex-row w-full justify-start items-start gap-4">
                <div className="text-white text-6xl md:text-[50px] p-0 md:py-2 animate-fade-in font-semibold font-fredoka uppercase leading-10">
                  01
                </div>
                <div className="flex-col flex justify-start items-start gap-6">
                  <div className="flex-col w-full justify-start items-start gap-5 flex">
                    <div className="w-full gap-3">
                      <span className="text-white animate-fade-in claraheading">
                        Select Your Preferred <br />
                      </span>
                      <span className="text-red animate-fade-in w-[max-content] claraheading">
            ...
            <Image
              alt="Kindi"
              src={Curve}
              className="hidden md:hidden lg:flex w-[50%] -mb-12 -mt-24"
            />
            ...
            <div className="flex flex-col  lg:flex-row xl:flex-row w-full items-center justify-between py-8 gap-4">
              ...
              <div className="min-h-[300px] animate-fade-in  flex flex-col md:flex-row w-full justify-start items-start gap-4">
                <div className="text-white text-6xl md:text-[50px] p-0 md:py-2  font-semibold font-fredoka uppercase leading-10">
                  02
                </div>
                <div className="flex-col flex justify-start items-start gap-6">
                  <div className="flex-col w-full justify-start items-start gap-5 flex">
            ...
            <Image
              alt="Kindi"
              src={CurveTwo}
              className="transform hidden md:hidden lg:flex -rotate-180 w-[56%]  -mt-24 -mb-16"
            />

            {/* Section Three */}
            <div className="flex flex-col-reverse lg:flex-row xl:flex-row w-full items-center justify-between py-0 md:py-8 gap-6">
              <div className="min-h-[300px] animate-fade-in  flex flex-col md:flex-row w-full justify-start items-start gap-4">
                <div className="text-white text-6xl md:text-[50px] lg:text-[50px] p-0 md:py-2  font-semibold font-fredoka uppercase leading-10">
                  03
                </div>
                <div className="flex-col flex justify-start items-start gap-6">
                  <div className="flex-col w-full justify-start items-start gap-5 flex">
                    <div className="w-full gap-3">
                      ...
                      <span className="text-red w-[max-content] animate-fade-in claraheading">
                        {" "}
                        Precious Time{" "}
                      </span>
                    </div>
