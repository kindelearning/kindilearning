  ...
  return (
    <section className="min-h-screen flex justify-center items-center bg-gray-100">
      <div className="claracontainer max-w-4xl w-full bg-white shadow-lg rounded-lg p-6">
        ...
        <MyLevel totalActivities={myLevels} />
        {/* <LevelProgress totalActivities={myLevels} /> */}
...
export function LevelProgress({ totalActivities }) {
  ...
  const progress = (totalActivities / currentLevel.noOfActivities) * 100;

  return (
    <div className="p-6 font-fredoka bg-white shadow-lg rounded-lg max-w-md mx-auto">
      <div className="flex  w-full justify-between items-center">
        ...
        <span className="text-gray-600">
          {totalActivities} / {currentLevel.noOfActivities} Activities
        </span>
      </div>
