...
export default function AdminThemes() {
  ...
  const fetchThemes = async () => {
    const res = await fetch("https://kindiadmin.up.railway.app/api/our-themes?populate=*");
                            ...
                            <div className="w-full flex flex-col">
                              <div className="flex w-full gap-4 justify-between items-start">
                                ...
                                <img
                                  ...
                                  // src={`https://kindiadmin.up.railway.app${selectedTheme?.Thumbnail?.url}`} // Assuming the image URL is in the 'image' property
