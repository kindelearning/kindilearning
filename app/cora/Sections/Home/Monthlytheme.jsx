...
//       const response = await fetch(
//         `https://lionfish-app-98urn.ondigitalocean.app/api/Monthlytheme?${documentId}`, // Correct URL with query parameter for documentId
//         {
//           method: "PUT",
//           headers: {
...
export function UpdateMonthlytheme() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://lionfish-app-98urn.ondigitalocean.app/api/Monthlytheme", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
