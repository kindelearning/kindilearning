...
export const getAnnualPricingData = async () => {
  ...
  try {
    ...
    const jsonData = await res.json();
    return jsonData.data?.annualPricing || null; // Correctly accessing ourStories here
  } catch (error) {
    console.error("Error fetching story data:", error);
    return null;
  }
...
export const getMonthlyPricingData = async () => {
  ...
  try {
    ...
    const jsonData = await res.json();
    return jsonData.data?.monthlyPricing || null; // Correctly accessing ourStories here
  } catch (error) {
    console.error("Error fetching story data:", error);
    return null;
  }
